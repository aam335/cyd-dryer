...
void ui_config_screen_init(void)
{
    ...
    lv_textarea_set_text(ui_R25_Ohm, "45.79999954");
    ...
    lv_textarea_set_text(ui_R_div_Ohm, "45.79999954");
    ...
    lv_textarea_set_text(ui_beta, "45.79999954");
    ...
    ui_Button2 = lv_btn_create(ui_Label23);
