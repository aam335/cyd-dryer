...
void ui_config_screen_init(void)
{
    ...
    lv_obj_remove_flag(ui_maxmenutemp, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_minmenutemp, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_fan, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_minmenutemp2, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_pids, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_ku_Container1, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_tu_Container2, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_reset_pid_button = lv_button_create(ui_config);
    ...
    lv_obj_remove_flag(ui_reset_pid_button, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_return = lv_button_create(ui_config);
    ...
    ui_reset_pid = lv_button_create(ui_config);
    ...
    lv_obj_remove_flag(ui_reset_pid, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
