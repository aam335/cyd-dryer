...
void ui_Screen1_screen_init(void)
{
    ...
    lv_obj_clear_flag(ui_temeratureindicator, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_clear_flag(ui_onoffarea, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_online = lv_spinner_create(ui_temeratureindicator, 1000, 90);
    lv_obj_set_width(ui_online, lv_pct(70));
    lv_obj_set_height(ui_online, lv_pct(70));
    lv_obj_set_align(ui_online, LV_ALIGN_CENTER);
    lv_obj_clear_flag(ui_online, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_GESTURE_BUBBLE | LV_OBJ_FLAG_SNAPPABLE |
    ...
    ui_minus60 = lv_btn_create(ui_mainscreen);
    ...
    lv_obj_set_style_shadow_ofs_x(ui_minus60, 1, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_ofs_y(ui_minus60, 1, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    ui_minus30m = lv_btn_create(ui_mainscreen);
    ...
    lv_obj_set_style_shadow_ofs_x(ui_minus30m, 1, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_ofs_y(ui_minus30m, 1, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    ui_plus1h = lv_btn_create(ui_mainscreen);
    ...
    lv_obj_set_style_shadow_ofs_x(ui_plus1h, 1, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_ofs_y(ui_plus1h, 1, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    ui_plus30m = lv_btn_create(ui_mainscreen);
    ...
    lv_obj_set_style_shadow_ofs_x(ui_plus30m, 1, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_ofs_y(ui_plus30m, 1, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    ui_Button3 = lv_btn_create(ui_sensor);
